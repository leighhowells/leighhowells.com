...
return [
    ...
    'timestamp' => 1590648704,
    'checksum' => '94605b3d22146d0325dd183464cf2384',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'plugins/SSG' => [
                'file' => 'user/config/plugins/SSG.yaml',
                'modified' => 1590644218
            ],
            ...
            'plugins/generator' => [
                'file' => 'user/config/plugins/generator.yaml',
                'modified' => 1590644217
            ],
    ...
    'data' => [
        'plugins' => [
            ...
            'generator' => [
                ...
                'destination_folder' => '../',
                'destination_domain' => 'leighhowells.com',
                'exclude' => 'backup
audio',
                'cache_manifest' => 'on'
            ],
