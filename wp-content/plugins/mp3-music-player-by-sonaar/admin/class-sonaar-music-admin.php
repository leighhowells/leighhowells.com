...
class Sonaar_Music_Admin {
    ...
    */
    ...
    public function init_options() {
        ...
        $options_name = array();
            ...
            if( Sonaar_Music::get_option('player_type', 'srmp3_settings_general') === 'podcast' || Sonaar_Music::get_option('player_type', 'srmp3_settings_general') === 'radio' ){
                $general_options->add_field( array(
            ...
            if ( function_exists( 'run_sonaar_music_pro' ) ){
                ...
                $general_options->add_field( array(
                    'name'          => __('Download Label', 'sonaar-music'),
                    'id'            => 'force_cta_download_label',
                    'type'          => 'text_small',
                    'default'       => esc_html__('Download', 'sonaar-music'),
                    'attributes'    => array(
                        'data-conditional-id'    => 'force_cta_download',
                ...
                $general_options->add_field( array(
                    ...
                    'attributes'    => array(
                        'data-conditional-id'    => 'force_cta_singlepost',
                        'data-conditional-value' => 'true',
    ...
    **/
    ...
    /*public static function sr_GetString( $string ){
        ...
        switch ( $string ){
            ...
            case 'Track Album':
                ...
                break;
            case 'Artist Name':
                $label = ( $playerType == 'music' )? esc_html__( 'Artist Name', 'sonaar-music' ) : esc_html__( 'Speaker Name', 'sonaar-music' );
                break;
            case 'Album Subtitle':
    ...
    public static function sr_GetString($string)
    {
        ...
        $labels = [
            'Album Infos' => [
                'classic'   => __('Album Infos', 'sonaar-music'),
                'podcast' => __('Podcast Infos', 'sonaar-music'),
                'radio'   => __('Station Infos', 'sonaar-music'),
            ],
            'Track Title' => [
            ...
            'All Playlists' => [
                'classic'   => __('All Playlists', 'sonaar-music'),
                'podcast' => __('All Episodes', 'sonaar-music'),
                'radio'   => __('All Stations', 'sonaar-music'),
            ],
            'Playlists' => [
                'classic'   => __('Playlists', 'sonaar-music'),
            ...
            'Playlist Categories' => [
                'classic'   => esc_html_x('Playlist Categories', 'Taxonomy : name', 'sonaar-music'),
                'podcast' => esc_html_x('Podcast Categories', 'Taxonomy : name', 'sonaar-music'),
                'radio'   => esc_html_x('Station Categories', 'Taxonomy : name', 'sonaar-music'),
            ],
            'Edit Playlist' => [
            ...
            'Album Title' => [
                'classic'   => __('Album Title', 'sonaar-music'),
                'podcast' => __('Player Title', 'sonaar-music'),
                'radio'   => __('Station Title', 'sonaar-music'),
            ],
            'Album Subtitle 2' => [
                'classic'   => __('Album Subtitle', 'sonaar-music'),
    ...
    **/
    ...
    public function srmp3_create_postType(){
        ...
        $album_tag_args = array(
            ...
            'show_admin_column' => true,
            'labels' => array(
                'name' => $this->sr_GetString('Playlist') . ' ' . __('Tags', 'sonaar-music'),
                'singular_name' => $this->sr_GetString('Playlist') . ' ' . __('Tag', 'sonaar-music'),
                'search_items' => sprintf(__('Search %1$s Tag:','sonaar-music'), $this->sr_GetString('Playlist') ),
                'all_items' => sprintf(__('All %1$s Tags','sonaar-music'), $this->sr_GetString('Playlist') ),
                'parent_item' => sprintf(__('Parent %1$s Tag','sonaar-music'), $this->sr_GetString('Playlist') ),
                'parent_item_colon' => sprintf(__('Parent %1$s Tag:','sonaar-music'), $this->sr_GetString('Playlist') ),
                'edit_item' => sprintf(__('Edit %1$s Tag','sonaar-music'), $this->sr_GetString('Playlist') ),
                'update_item' => sprintf(__('Update %1$s Tag','sonaar-music'), $this->sr_GetString('Playlist') ),
                'add_new_item' => sprintf(__('Add New %1$s Tag','sonaar-music'), $this->sr_GetString('Playlist') ),
                'new_item_name' => sprintf(__('New %1$s tag name','sonaar-music'), $this->sr_GetString('Playlist') ),
                'menu_name' => $this->sr_GetString('Playlist') . ' ' . __('Tags', 'sonaar-music')
            ),
            'public' => true,
