...
class SRMP3_CMBS_SerkanA_Plugin_IConSelectFA {
	...
	public function render_faiconselect( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
		...
		//var_dump($field_type_object->concat_items());
...
function srmp3_returnRayFaPre() {
	include 'predefined-array-fontawesome.php';
	return array_merge($sricons,$fontAwesome);
}

new SRMP3_CMBS_SerkanA_Plugin_IConSelectFA();
